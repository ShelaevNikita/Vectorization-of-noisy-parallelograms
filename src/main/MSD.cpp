...
private:
    ...
    double f_min_para(double bmin1, double bmax1, double bmin2, double bmax2, double &k, double &b1, double &b2,
                      const vector<pair<double, double>>& points1, const vector<pair<double, double>>& points2) {
        double sum = 0.0;
    ...
    double f_min_mono(double bmin, double bmax, double &k, double &b, const vector<pair<double, double>>& points) {
        double sum = 0.0;
...
public:
    ...
    void MSD_main(const vector<vector<pair<double, double>>>& Points, vector<pair<double, double>> Lines,
